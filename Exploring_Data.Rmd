...
LOESS_Soybean<- loess(value ~ decimal_date(Date), data = historical.prices, span = 0.5)

historical.prices_na<-historical.prices[complete.cases(historical.prices), ]

historical.prices_na

ggplot(historical.prices_na)+
  geom_line(aes(x = Date, y = value))+
  geom_line(aes(x = Date, y = predict(Soybean_gam),color = "Loess"))
```
